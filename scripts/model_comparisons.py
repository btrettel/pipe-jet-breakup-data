...
f.write(r'\caption{Table with calibrated model coefficients for multiple models.}'+'\n')
...
f.write(r'\end{tabular}'+'\n')
f.write(r'\caption{Table with coefficients of determination ($R^2$) for each model with calibrated model coefficients.}'+'\n')
